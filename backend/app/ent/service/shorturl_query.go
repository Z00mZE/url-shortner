...
//
//	client.ShortUrl.Query().
//		Select(shorturl.FieldURL).
//		Scan(ctx, &v)
//
func (suq *ShortUrlQuery) Select(fields ...string) *ShortUrlSelect {
...
func (suq *ShortUrlQuery) prepareQuery(ctx context.Context) error {
	for _, f := range suq.fields {
		if !shorturl.ValidColumn(f) {
			return &ValidationError{Name: f, err: fmt.Errorf("service: invalid field %q for query", f)}
		}
	}
	if suq.path != nil {
...
func (suq *ShortUrlQuery) sqlAll(ctx context.Context) ([]*ShortUrl, error) {
	...
	_spec.Assign = func(columns []string, values []interface{}) error {
		if len(nodes) == 0 {
			return fmt.Errorf("service: Assign called without calling ScanValues")
		}
...
func (suq *ShortUrlQuery) sqlExist(ctx context.Context) (bool, error) {
	...
	if err != nil {
		return false, fmt.Errorf("service: check existence: %w", err)
	}
	return n > 0, nil
}
...
func (sugb *ShortUrlGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("service: ShortUrlGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *ShortUrlGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sugb *ShortUrlGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("service: ShortUrlGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *ShortUrlGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sugb *ShortUrlGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("service: ShortUrlGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *ShortUrlGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sugb *ShortUrlGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sugb.fields) > 1 {
		return nil, errors.New("service: ShortUrlGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sugb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sugb *ShortUrlGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *ShortUrlSelect) Strings(ctx context.Context) ([]string, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("service: ShortUrlSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *ShortUrlSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *ShortUrlSelect) Ints(ctx context.Context) ([]int, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("service: ShortUrlSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *ShortUrlSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *ShortUrlSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("service: ShortUrlSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *ShortUrlSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sus *ShortUrlSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(sus.fields) > 1 {
		return nil, errors.New("service: ShortUrlSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := sus.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sus *ShortUrlSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{shorturl.Label}
	default:
		err = fmt.Errorf("service: ShortUrlSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
