...
func ExpiredAt(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
...
func ExpiredAtEQ(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldExpiredAt), v))
	})
}
...
func ExpiredAtNEQ(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
...
func ExpiredAtIn(vs ...time.Time) predicate.ShortUrl {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiredAtNotIn(vs ...time.Time) predicate.ShortUrl {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ExpiredAtGT(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
...
func ExpiredAtGTE(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
...
func ExpiredAtLT(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
...
func ExpiredAtLTE(v time.Time) predicate.ShortUrl {
	return predicate.ShortUrl(func(s *sql.Selector) {
